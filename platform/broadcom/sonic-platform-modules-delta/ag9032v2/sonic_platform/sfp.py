...
class Sfp(SfpBase):
    ...
    PLATFORM = "x86_64-delta_ag9032v2-r0"
    HWSKU = "Delta-ag9032v2"
    SWPLD_I2C_PATH = "/sys/devices/platform/delta-ag9032v2-swpld1.0/"
    ...
    def get_transceiver_info(self):
        ...
        if self.port_num > self.QPORT_END+1:
    ...
    def get_transceiver_bulk_status(self):
        ...
        """
        # check present status
        if self.port_num > self.QPORT_END+1: #SFP case
            sfpd_obj = sff8472Dom()
    ...
    def get_tx_bias(self):
        ...
        if self.port_num > self.QPORT_END:
    ...
    def get_presence(self):
        ...
        """
        # Check for invalid port_num
        if self.port_num < self.QPORT_START or self.port_num > self.PORT_END:
            return False
